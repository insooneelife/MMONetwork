...
#ifndef PROTOBUF_SnakeAdditionalData_2eproto__INCLUDED
#define PROTOBUF_SnakeAdditionalData_2eproto__INCLUDED
...
class SnakeAdditionalData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Data.SnakeAdditionalData) */ {
 public:
  SnakeAdditionalData();
  virtual ~SnakeAdditionalData();

  SnakeAdditionalData(const SnakeAdditionalData& from);

  inline SnakeAdditionalData& operator=(const SnakeAdditionalData& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const SnakeAdditionalData& default_instance();

  static inline const SnakeAdditionalData* internal_default_instance() {
    return reinterpret_cast<const SnakeAdditionalData*>(
               &_SnakeAdditionalData_default_instance_);
  }

  void Swap(SnakeAdditionalData* other);

  // implements Message ----------------------------------------------

  inline SnakeAdditionalData* New() const PROTOBUF_FINAL { return New(NULL); }

  SnakeAdditionalData* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const SnakeAdditionalData& from);
  void MergeFrom(const SnakeAdditionalData& from);
  ...
  void InternalSwap(SnakeAdditionalData* other);
  private:
  ...
  // @@protoc_insertion_point(class_scope:Data.SnakeAdditionalData)
 private:
  ...
  int control_type_;
  friend struct  protobuf_SnakeAdditionalData_2eproto::TableStruct;
};
// ===================================================================
...
// repeated .Data.Vec2 bodies = 1;
inline int SnakeAdditionalData::bodies_size() const {
  return bodies_.size();
}
inline void SnakeAdditionalData::clear_bodies() {
  bodies_.Clear();
}
inline const ::Data::Vec2& SnakeAdditionalData::bodies(int index) const {
  // @@protoc_insertion_point(field_get:Data.SnakeAdditionalData.bodies)
  return bodies_.Get(index);
}
inline ::Data::Vec2* SnakeAdditionalData::mutable_bodies(int index) {
  // @@protoc_insertion_point(field_mutable:Data.SnakeAdditionalData.bodies)
  return bodies_.Mutable(index);
}
inline ::Data::Vec2* SnakeAdditionalData::add_bodies() {
...
// required .Data.ControlType control_type = 2;
inline bool SnakeAdditionalData::has_control_type() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void SnakeAdditionalData::set_has_control_type() {
  _has_bits_[0] |= 0x00000001u;
}
inline void SnakeAdditionalData::clear_has_control_type() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void SnakeAdditionalData::clear_control_type() {
  control_type_ = 0;
  clear_has_control_type();
}
inline ::Data::ControlType SnakeAdditionalData::control_type() const {
  // @@protoc_insertion_point(field_get:Data.SnakeAdditionalData.control_type)
  return static_cast< ::Data::ControlType >(control_type_);
}
inline void SnakeAdditionalData::set_control_type(::Data::ControlType value) {
...
#endif  // PROTOBUF_SnakeAdditionalData_2eproto__INCLUDED
