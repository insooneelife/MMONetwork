...
const PacketType PacketType_MAX = ReplicateWorld;
...
const Command Command_MIN = MoveLeft;
const Command Command_MAX = MoveRight;
...
template <> struct is_proto_enum< ::Data::Command> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Data::Command>() {
  return ::Data::Command_descriptor();
}
